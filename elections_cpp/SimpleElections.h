...
namespace elections {
	...
	public:
		...
		virtual void addPerson(const std::string& name, int id, int birth_year, int distric_id = 1) override;

		// Add a person as a candidate of a party in a given district
		virtual void addPersonAsCandidate(int person_id, int party_id, int distric_id = 1) override;
