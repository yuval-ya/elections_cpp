...
namespace elections {
	...
	public:
		...
		virtual bool addDistrict(const String& name, int number_of_candidates, DistrictType type) override;

		// add a new person to the voters list and to the district he belongs
		virtual bool addPerson(const String& name, int id, int birth_year, int distric_id = 1) override;
